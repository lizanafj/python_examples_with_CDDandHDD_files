...
#Select file name
file_name = "HDD_historical_mean_v1"
variable = "Heating Degree Days (HDD)" #OR "Heating Degree Days (HDD)"

#variables
lat = "latitude0"
long = "longitude0"
value = "HDD_total" #OR "HDD_total"
...
vmin, vmax = 0, 5000
levels = np.linspace(vmin, vmax, 21)  # 14 bins
cmap = get_cmap('plasma_r', len(levels)-1)
...
cb.set_ticks(np.arange(0, 5001, 500))
